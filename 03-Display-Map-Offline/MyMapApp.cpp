...
void MyMapApp::loadOfflineBasemaps()
{
  ...
  if (QFile::exists(appDataPath+"/vectorTiles.vtpk"))
  {
    ...
    {
      m_offlineLayer = new ArcGISVectorTiledLayer(m_vectorTileCache, m_tempParent.get());
    }
